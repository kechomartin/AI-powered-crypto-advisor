import{An as e,Bo as t,C as n,Cn as r,E as i,M as a,Mn as o,P as s,Ro as c,a as l,ei as u,x as d}from"./index-CvvJlGac.js";import{t as f}from"./createLucideIcon-BQ2DJFQt.js";import{t as p}from"./check-DNwHwLGT.js";import{t as m}from"./poll-DCqCcokj-CD_MDqeI.js";import{t as h}from"./circle-x-35J2II4h.js";import{t as g}from"./smartphone-C11Y8dse.js";import{t as ee}from"./triangle-alert-Bq5bXChE.js";import{t as _}from"./wallet-D7ieBShj.js";import{t as v}from"./ScreenLayout-yWVsP0Du-h_cLjSqC.js";import{n as y,r as b,t as x}from"./SelectSourceAsset-B1eIAAfk-Ia2lo8Gn.js";import{n as S,t as C}from"./GooglePay-DA-Ff7zK-JKXMBmBx.js";var w=f(`building`,[[`path`,{d:`M12 10h.01`,key:`1nrarc`}],[`path`,{d:`M12 14h.01`,key:`1etili`}],[`path`,{d:`M12 6h.01`,key:`1vi96p`}],[`path`,{d:`M16 10h.01`,key:`1m94wz`}],[`path`,{d:`M16 14h.01`,key:`1gbofw`}],[`path`,{d:`M16 6h.01`,key:`1x0f13`}],[`path`,{d:`M8 10h.01`,key:`19clt8`}],[`path`,{d:`M8 14h.01`,key:`6423bh`}],[`path`,{d:`M8 6h.01`,key:`1dz90k`}],[`path`,{d:`M9 22v-3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3`,key:`cabbwy`}],[`rect`,{x:`4`,y:`2`,width:`16`,height:`20`,rx:`2`,key:`1uxh74`}]]),te=f(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),T=f(`credit-card`,[[`rect`,{width:`20`,height:`14`,x:`2`,y:`5`,rx:`2`,key:`ynyp8z`}],[`line`,{x1:`2`,x2:`22`,y1:`10`,y2:`10`,key:`1b3vmo`}]]),E=f(`landmark`,[[`path`,{d:`M10 18v-7`,key:`wt116b`}],[`path`,{d:`M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z`,key:`1m329m`}],[`path`,{d:`M14 18v-7`,key:`vav6t3`}],[`path`,{d:`M18 18v-7`,key:`aexdmj`}],[`path`,{d:`M3 22h18`,key:`8prr45`}],[`path`,{d:`M6 18v-7`,key:`1ivflk`}]]),D=c();t(),u();var[O,k]=((e,t=750)=>{let n;return[(...r)=>{n&&clearTimeout(n),n=setTimeout((()=>{e(...r)}),t)},()=>{n&&clearTimeout(n)}]})((async(e,t)=>{n({isLoading:!0});try{let{getQuotes:r}=d(),i=await r({source:{asset:t.source.selectedAsset.toUpperCase(),amount:e},destination:{asset:t.destination.asset.toUpperCase(),chain:t.destination.chain,address:t.destination.address},environment:t.environment}),o=i.quotes??[],s=i.provider_errors,c=a(o,e);n({localQuotes:o,localSelectedQuote:o[0]??null,isLoading:!1,quotesWarning:c,quotesErrors:s??null})}catch{n({localQuotes:[],localSelectedQuote:null,quotesWarning:`provider_errors`,quotesErrors:null})}})),A=e=>{n({amount:e});let{opts:t}=d();O(e,t)},j=async()=>{let{error:e,state:t,onFailure:n,onSuccess:r}=d();k(),e?n(e):t.status===`provider-success`?await r({status:`confirmed`}):t.status===`provider-confirming`?await r({status:`submitted`}):n(Error(`User exited flow`))},M=async()=>{let t,r=i();if(!r)return;let a=e();if(!a)return void n({state:{status:`provider-error`},error:Error(`Unable to open payment window`)});n({isLoading:!0});let{opts:o,amount:s,getProviderUrl:c,getStatus:l,controller:u}=d(),f=()=>{try{a.closed||a.close()}catch{}};u.current=new AbortController;try{let e=await c({source:{asset:o.source.selectedAsset.toUpperCase(),amount:s||`0`},destination:{asset:o.destination.asset.toUpperCase(),chain:o.destination.chain,address:o.destination.address},provider:r.provider,sub_provider:r.sub_provider??void 0,payment_method:r.payment_method,redirect_url:window.location.origin});a.location.href=e.url,t=e.session_id}catch{f(),n({state:{status:`provider-error`},isLoading:!1,error:Error(`Unable to start payment session`)});return}n({isLoading:!1}),n({state:{status:`provider-confirming`}});let p=await m({operation:()=>l({session_id:t,provider:r.provider}),until:e=>e.status===`completed`||e.status===`failed`||e.status===`cancelled`,delay:0,interval:2e3,attempts:60,signal:u.current.signal});if(p.status!==`aborted`){if(p.status===`max_attempts`)return f(),p.error?(console.error(p.error),void n({state:{status:`select-amount`},isLoading:!1,error:Error(`Unable to check payment status. Please try again.`)})):void n({state:{status:`provider-error`},error:Error(`Could not confirm payment status yet.`)});p.result?.status===`completed`?(f(),n({state:{status:`provider-success`}})):(f(),n({state:{status:`provider-error`},error:Error(`Transaction ${p.result?.status??`failed`}`)}))}},N=()=>{let e=l();e&&e.length>0&&n({state:{status:`select-payment-method`,quotes:e}})},P=()=>{n({state:{status:`select-source-asset`}})},F=()=>{n({error:null,state:{status:`select-amount`}})},I=e=>{n({localSelectedQuote:e,state:{status:`select-amount`}})},L=e=>{let{opts:t,amount:r}=d(),i={...t,source:{...t.source,selectedAsset:e}};n({opts:i,state:{status:`select-amount`}}),O(r,i)},R=({onClose:e})=>(0,D.jsx)(v,{showClose:!0,onClose:e,iconVariant:`loading`,title:`Processing transaction`,subtitle:`Your purchase is in progress. You can leave this screen — we’ll notify you when it’s complete.`,primaryCta:{label:`Done`,onClick:e},watermark:!0}),z=({onClose:e,onRetry:t})=>(0,D.jsx)(v,{showClose:!0,onClose:e,icon:h,iconVariant:`error`,title:`Something went wrong`,subtitle:`We couldn't complete your transaction. Please try again.`,primaryCta:{label:`Try again`,onClick:t},secondaryCta:{label:`Close`,onClick:e},watermark:!0}),B=({onClose:e})=>(0,D.jsx)(v,{showClose:!0,onClose:e,icon:p,iconVariant:`success`,title:`Transaction confirmed`,subtitle:`Your purchase is processing. Funds should arrive in your wallet within a few minutes.`,primaryCta:{label:`Done`,onClick:e},watermark:!0}),V={CREDIT_DEBIT_CARD:`card`,APPLE_PAY:`Apple Pay`,GOOGLE_PAY:`Google Pay`,BANK_TRANSFER:`bank deposit`,ACH:`bank deposit`,SEPA:`bank deposit`,PIX:`PIX`},ne={CREDIT_DEBIT_CARD:(0,D.jsx)(T,{size:14}),APPLE_PAY:(0,D.jsx)(g,{size:14}),GOOGLE_PAY:(0,D.jsx)(g,{size:14}),BANK_TRANSFER:(0,D.jsx)(w,{size:14}),ACH:(0,D.jsx)(w,{size:14}),SEPA:(0,D.jsx)(w,{size:14}),PIX:(0,D.jsx)(_,{size:14})},H=e=>ne[e]??(0,D.jsx)(T,{size:14}),U=({opts:e,onClose:t,onEditSourceAsset:n,onEditPaymentMethod:r,onContinue:i,onAmountChange:a,amount:o,selectedQuote:s,quotesWarning:c,quotesErrors:l,quotesCount:u,isLoading:d})=>{return(0,D.jsxs)(v,{showClose:!0,onClose:t,headerTitle:`Buy ${e.destination.asset.toLocaleUpperCase()}`,primaryCta:{label:`Continue`,onClick:i,loading:d,disabled:!s},helpText:c?(0,D.jsxs)(W,{children:[(0,D.jsx)(ee,{size:16,strokeWidth:2}),(0,D.jsx)(G,{children:(0,D.jsxs)(D.Fragment,c===`amount_too_low`?{children:[(0,D.jsx)(K,{children:`Amount too low`}),(0,D.jsx)(q,{children:`Please choose a higher amount to continue.`})]}:{children:[(0,D.jsx)(K,{children:`Unable to get quotes`}),(0,D.jsx)(q,{children:l?.[0]?.error??`Something went wrong. Please try again.`})]})})]}):s&&u>1?(0,D.jsxs)(J,{onClick:r,children:[H(s.payment_method),(0,D.jsxs)(`span`,{children:[`Pay with `,(f=s.payment_method,V[f]??f.replace(/_/g,` `).toLowerCase().replace(/^\w/,(e=>e.toUpperCase())))]}),(0,D.jsx)(te,{size:14})]}):null,watermark:!0,children:[(0,D.jsx)(x,{currency:e.source.selectedAsset,value:o,onChange:a,inputMode:`decimal`,autoFocus:!0}),(0,D.jsx)(y,{selectedAsset:e.source.selectedAsset,onEditSourceAsset:n})]});var f},W=r.div`
  display: flex;
